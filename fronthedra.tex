...
%\normalsize
\begin{flushleft}
\ifdef{\logo}{\IfFileExists{\logo}{\includegraphics[width=3cm]{\logo}\logoum{}\\ São Paulo\_\the\year}}{\logoum\break{} São Paulo\quad\the\year}
\end{flushleft}
...
%\part[{{\def\break{}\titulo}}]{\Formular\titulo}

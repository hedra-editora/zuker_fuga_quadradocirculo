\part[\footnotesize\MakeUppercase{\textbf{EM ROTA DE FUGA}}]{\Formular{Em rota de fuga}}
...
política francesa ao longo da segunda metade do século \versal{XX}.
Certamente
...
imagem em tudo, em tudo vê seu próprio reflexo.
...
\section*{ARTAUD E O TEATRO COMO PESTE}
...
\addcontentsline{toc}{chapter}{A pedagogia do medo}
...
\section*{NEOLIBERALISMO E A\break EDUCAÇÃO SENTIMENTAL}
%\addcontentsline{toc}{section}{Neoliberalismo e a educação sentimental}
...
econômica''.\footnote{``Neoliberalism: the idea that swallowed the world'', {\slsc{The Guardian}}, 18/08/2017.}
...
nesse idealismo; parecem forjados à imagem do conceito de guerra de todos
...
fazem diversos filósofos políticos, entre eles Hannah Arendt, em
...
genocídio, aos olhos nazistas, assumiam uma função criadora, capaz de dar
luz a um novo mundo.
...
sentimentos pelo terror. Uma nova educação sentimental, em que o cultivo
...
implica uma maior demanda
de trabalho dos humanos, que passa a ser
...
Em um texto opinativo publicado por Malcolm Harris na \emph{Al Jazeera},\footnote{``The real cultural explanation for school shootings'', {\slsc{Al Jazeera}}, 16/12/2015.}
...
experientes do órgão.\footnote{\scalebox{.8}{OSTRY}, Jonathan D.; \scalebox{.8}{LOUNGANI}, Prakash; \scalebox{.8}{FURCERI}, Davide. ``Neoliberalism: Oversold?'', {\slsc{Finance \& Development}}, 06/2016.}
...
exportado. Segundo Friedman, a dobradinha aumento da
...
\begin{figure}[H]
\thispagestyle{empty}
  \includegraphics[width=75mm]{./imgs/img4.jpg}  
\end{figure}
...
%\addcontentsline{toc}{section}{Pequena teoria visual do medo}
...
transformações, prestes a se desfazer, a se estatelar no
...
tornou"-se o motor para pensar as tensões envolvidas nas diferentes
...
\noindent{}os artistas tivessem"-nas em mente no momento de
...
``destacar de seu plano de fundo religioso'',\footnote{Ibidem, p.~123.}
...
poder com a nobreza.~São análises do universo pictórico
...
\thispagestyle{empty}
\centering
  \includegraphics[width=75mm]{./imgs/img6.jpg}  
\end{figure}
...
ficaram enterrados em um passado longínquo. Embora associadas com o
...
Outro aspecto da proliferação dessas imagens de violência extrema está no
contexto dos \emph{snuff films}. São vídeos transmitidos pela internet com
...
guerra a fim de sensibilizar a opinião pública. ``Ser um espectador de calamidades que acontecem em outro país, é uma experiência moderna por excelência, a oferta acumulada de mais de um século e meio desses profissionais, turistas especializados conhecidos como jornalistas''.\footnote{Ibidem, p.~18 (trad.~minha).}
...
exterminar os vestígios: o esfacelamento dos corpos e dispersão em
...
exibe quanto no que oculta''.\footnote{Ibidem, p.~38.}

\movetooddpage
\thispagestyle{empty}
\begin{figure}[H]
\centering
  \includegraphics[width=55mm]{./imgs/img8.jpg}  
\end{figure}
...
orgulho, como
em falas de que a ditadura ``salvou o país do comunismo'',
...
mesmo o
revisionismo mais tacanho, de equiparar torturadores a
...
\begin{figure}[!ht]
\centering
 \includegraphics[width=\textwidth]{./imgs/crer.png}
...
indígenas, a partir de minuciosa pesquisa em arquivos. 
Essa imagem,
...
trabalhadores sem"-terra, do Sul do país e da região
Nordeste,
...
\begin{figure}[H]
\centering
  \includegraphics[width=85mm]{./imgs/img11.jpg}  
\end{figure}
...
Gabriela B. (a militante preferiu ocultar seu
sobrenome com receio de
...
que se rompeu em Mariana. Na primeira versão deste ensaio, o ocorrido em Mariana era considerado a maior tragédia ambiental do país; de lá para cá, tivemos também Brumadinho, que torna qualquer competição pelo ``pior'' irrelevante e assombrosa.
...
povo Sikuani, que vive na fronteira entre a Amazônia colombiana e venezuelana, ``nossos avós viveram muitos anos. Naquela época, não tinha
...
São elas que estão lutando pela \linebreak 


\movetooddpage
\thispagestyle{empty}
\begin{figure}[H]
  \includegraphics[width=70mm]{./imgs/img12.jpg}  
\end{figure}
...
\noindent{}defesa de seus territórios, pois seus
...
elétricos, por exemplo, em barcos que antes eram navegados a remo, pode
...
persecutório e conspiracionista.
...
praça no centro do Rio de Janeiro, em abril de 2016. Trata"-se do
projeto de transformar os índios em pobres, desmuni"-los de suas formas de
...
que mexia no celular em um canto do bar.
...
trabalhar''. 
Sua esposa, pertencente ao povo Taurepang, me pedia
...
ressoem, com todos os equívocos envolvidos, em nossa forma genocida e \enlargethispage{\baselineskip}
...
\addcontentsline{toc}{chapter}{Vertigem: por uma escrita do ruído}
...
\noindent{}Este ensaio reflete sobre algumas formas de escrita entre não ficção
...
\noindent{}que nele ocorre, opaca. De maneiras e graus distintos,
...
Um sem número de autores se coloca como tarefa repensar a
...
Sociais na Universidade de São 
Paulo, e não raro encontrava colegas de
...
iranianos, e por outro lado contratava noruegueses, alemães e britânicos que
...
\thispagestyle{empty}
\begin{figure}[H]
  \includegraphics[width=83mm]{./imgs/img15.jpg}  
\end{figure}
...
independente do colonialismo europeu. O clima de entusiasmo era
visível:
...
Selassié I atribuía a si os méritos, devido a sua infalibilidade divina.~Caso fosse desastrosa, a culpa era imediatamente dirigida ao Ministro da
...
com função fática com a qual costumamos iniciar uma
conversa em
...
explicitamente violento, recebia o apoio de um grande número de pessoas \linebreak

\movetooddpage
\thispagestyle{empty}
\begin{figure}[H]
  \includegraphics[width=72mm]{./imgs/img16.jpg}  
\end{figure}
...
\noindent{}que até pouco tempo atrás tinham a sua preferência de votos entre a
...
\versal{XXI}. Iniciada pelo governo de Felipe Calderón, a guerra às drogas é
...
dão uma dimensão. Em 2007, o México registrou cerca
de oito mil
...
Rivera Garza aborda mais este caso de %\noindent{}
...
A obra também adentra a situação dos feminicídios no México. Sua interpretação
...
em badernas, com pessoas grosseiras, que não querem
comprar nada. Já as
...
voltou à suposta falta de produtividade que o programa do Bolsa Família
...
muito fácil de se dizer, quando a
pessoa que formula a frase possui
...
\chapter*{A incerteza\vspace{-.15cm}\break política em 2018\vspace{-.15cm}\break {\bold{Uma coleção de}}\vspace{-.15cm}\break {\bold{sonhos e pesadelos}}\footnote{Texto originalmente publicado no {\slsc{Nexo Jornal}} em 10/11/2018, em parceria com o psicanalista William Zeytounlian. O ensaio trata de sonhos e pesadelos de algumas pessoas durante o pleito eleitoral de 2018, que elegeu Bolsonaro como Presidente da República.}}
\addcontentsline{toc}{chapter}{A incerteza política em 2018} %[*]
...
\thispagestyle{empty}
\begin{figure}[H]
  \includegraphics[width=85mm]{./imgs/img19.jpg}  
\end{figure}
...
cabe aqui analisar detalhada e minuciosamente cada um desses sonhos.~Toda pessoa produz um universo único de símbolos e mobiliza memórias e
...
\thispagestyle{empty}
\begin{figure}[H]
  \includegraphics[width=\textwidth]{./imgs/img20.jpg}  
\end{figure}

\chapter*{Jair Bolsonaro:\vspace{-.15cm}\break massa, vírus\vspace{-.15cm}\break e poder\footnote{Texto originalmente publicado no {\slsc{Le Monde Diplomatique Brasil}} em 26/03/2020.}} %[*]
\addcontentsline{toc}{chapter}{Jair Bolsonaro: massa, vírus e poder}
...
Planalto rumo a uma manifestação de simpatizantes seus que foram às
...
A Covid"-19 nos permite uma perspectiva diversa; auxilia a observar, a
...
Ao fazer uma radiografia da massa, destrincha seu principal mecanismo
...
transformado em cinzas. Também as pessoas, integradas à massa, perdem
...
que figura um leão (ele) cercado de hienas (mídia, Congresso \linebreak

\movetooddpage
\thispagestyle{empty}
\begin{figure}[H]
  \includegraphics[width=85mm]{./imgs/img21.jpg}  
\end{figure}
...
\noindent{}Nacional, \versal{STF} e seu próprio ex"-partido), dá uma dimensão palpável dessa paranoia.
...
ao vídeo de
Jandira Feghali\footnote{``Médica, Jandira Feghali dá show e faz a fala mais brilhante até agora sobre a situação'', {\slsc{YouTube}}, 18/03/2020.} de que a comunicação do governo para contenção do vírus
...
Vale a leitura do
texto da filósofa e militante Djamila Ribeiro\footnote{``Doméstica idosa que morreu no Rio cuidava da patroa contagiada pelo coronavírus'', {\slsc{Folha de S.\,Paulo}}, 19/03/2020.} sobre a situação de
...
\emph{Time}\footnote{``In the Battle Against Coronavirus, Humanity Lacks Leadership'', {\slsc{Time}}, 15/03/2020.} (trechos foram traduzidos ao português).\footnote{```Na luta contra o coronavírus, a humanidade precisa de lideranças globais', diz Yuval Harari'', {\slsc{Época Negócios}}, 19/03/2020.} Entre as ideias que o autor questiona está a de que a pandemia só tomou as dimensões que tomou devido ao mundo
...
Times},\footnote{``Yuval Noah Harari: the world after coronavirus'', {\slsc{Financial Times}}, 20/03/2020.} aponta para o perigoso aprimoramento de medidas de vigilância
...
possibilidade de governos monitorarem  \linebreak
...
\noindent{}características fisiológicas como
...
\section*{NOTA GERAL SOBRE O\break IMAGINÁRIO DA CATÁSTROFE}
...
``É o fim do mundo'',\footnote{``É o fim do mundo'', {\slsc{Revista Piauí}}, 04/2017.} o jornalista mostra como estes se previnem contra o
...
\section*{Cena 4. PRONUNCIAMENTO\break OFICIAL DE JAIR BOLSONARO SOBRE\break CORONAVÍRUS EM REDE NACIONAL}
...
histeria'' a serem combatidos. Diz que parte da grande mídia criou
...
\chapter*{Cura, doença\vspace{-.15cm}\break e tortura \vspace{-.15cm}\break {\bold{O ritual palaciano}}\vspace{-.15cm}\break {\bold{de Jair Bolsonaro}}\footnote{Texto modificado do originalmente publicado no {\slsc{Nexo Jornal}} em 12/05/2020.}}
\addcontentsline{toc}{chapter}{Cura, doença e tortura}

Jair Bolsonaro criou seu próprio ritual palaciano. Cercado por seguranças de paletó e óculos escuros, por militares fardados filmando aqueles que dele se aproximam, o presidente desce de um carro e caminha em direção às grades que cercam as imediações do Palácio da Alvorada. Mais próximos a ele estão os seus apoiadores. Um pouco mais à frente, e separados por um espaço vazio, os jornalistas.
...
Da Idade Média à Revolução Francesa existiram, tanto na França como na Inglaterra, reis milagreiros que, apenas com seu toque, curavam seus súditos. O historiador francês Marc Bloch, em \emph{Os reis taumaturgos}, se debruça sobre como soberanos restabeleciam a saúde daqueles acometidos por ``escrófula'', enfermidade originada da tuberculose, e que se manifesta na pele do pescoço sob o aspecto de gânglios, secreções malcheirosas e inchaços descomunais.
...
\noindent{}hesita em comungar com torturadores. Seu pacto com os mortos é um pacto com os assassinos de outrora, um pacto com aqueles que dispõem do corpo alheio para ouvir a verdade que desejam.
...
A performance ritual é marcada por uma inversão do coro teatral.~No teatro épico, tal como relido pelo dramaturgo alemão Bertolt Brecht, o coro cria um diálogo direto entre ator e plateia, que visa deixar clara determinada posição crítica ao público. Com Bolsonaro, o rito do poder não deixa espaço para questionamentos. O presidente é enaltecido e louvado por sua claque a cada resposta, as chamadas \emph{mitadas}.
...
\section*{CONFISCAR O TEMPO,\break SEQUESTRAR OS CORPOS}
...
\chapter*{Apêndice\vspace{-.15cm}\break {\bold{Xamanismo}}\vspace{-.15cm}\break {\bold{na esplanada}}}
\addcontentsline{toc}{chapter}{Xamanismo na esplanada}
...
\thispagestyle{empty}
\begin{figure}[H]
  \includegraphics[width=90mm]{./imgs/img24.jpg}  
\end{figure}
...
com a sua própria. Passos firmes. Mãos em riste.~Agitando chocalhos.~Murmurando palavras inaudíveis.

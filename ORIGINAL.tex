...
\chapter*{Jair Bolsonaro:\\ \emph{massa, vírus e poder}\footnote[*]{Texto originalmente publicado no {\slsc{Le Monde Diplomatique Brasil}} em 26/03/2020.}}
\addcontentsline{toc}{chapter}{Jair Bolsonaro: massa, vírus e poder}

\epigraph{A crise não é de ``confiança'', não é ``ética'', não é ``financeira''; não é
...
inclusive saúde, educação e tempo de vida. A crise é do capitalismo.}{Silvio Almeida}
...
\emph{Time}\footnote{Disponível em: \textless{}{\slsc{https://bit.ly/2XfJK3e}}\textgreater{}.} (trechos foram traduzidos ao português).\footnote{Disponível em: \textless{}{\slsc{https://glo.bo/34holbg}}\textgreater{}.} Entre os questionamentos do autor está a
...
policiais militares ocorrido no início do Ceará --- e as estranhas %início do Ceará?p.200
...
relação às curvas locais de crescimento da pandemia. Vale ressaltar também
a atuação do Ministro da Saúde, Luiz Henrique Mandetta, que compreende %Mandetta entra?p201
...
\section*{Ps: Cena 4. Pronunciamento oficial de~Jair~Bolsonaro~sobre~coronavírus em~rede~nacional}

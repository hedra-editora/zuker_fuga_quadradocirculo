...
Em um texto opinativo publicado por Malcolm Harris na \emph{Al Jazeera},\footnote{\scalebox{.8}{HARRIS}, Malcolm. ``The real cultural explanation for school shootings''.}
...
experientes do órgão.\footnote{\scalebox{.8}{OSTRY}, Jonathan D.; \scalebox{.8}{LOUNGANI}, Prakash; \scalebox{.8}{FURCERI}, Davide. ``Neoliberalism: Oversold?''.}
...
ao vídeo de
Jandira Feghali\footnote{Disponível em: \textless{}{\slsc{https://bit.ly/3e1SXlJ}}\textgreater{}.} de que a comunicação do governo para contenção do vírus
...
Vale a leitura do
texto da filósofa e militante Djamila Ribeiro\footnote{Disponível em: \textless{}{\slsc{https://bit.ly/2RkhHfn}}\textgreater{}.} sobre a situação de
...
\emph{Time}\footnote{Disponível em: \textless{}{\slsc{https://bit.ly/2XfJK3e}}\textgreater{}.} (trechos foram traduzidos ao português).\footnote{Disponível em: \textless{}{\slsc{https://glo.bo/34holbg}}\textgreater{}.} Entre as ideias que o autor questiona está a de que a pandemia só tomou as dimensões que tomou devido ao mundo
...
pressão arterial e batimentos cardíacos. Isso permite uma vigilância \linebreak

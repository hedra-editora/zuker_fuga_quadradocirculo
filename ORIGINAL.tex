...
\thispagestyle{empty}
\movetooddpage
\addcontentsline{toc}{chapter}{EM ROTA DE FUGA
\medskip}
\part*{\Formular{Em rota de fuga}}
...
\section*{\scalebox{.8}{ARTAUD E O TEATRO COMO PESTE}}
...
%\section*{\scalebox{.8}{PROPOSTA}}

\noindent{}Este ensaio se divide em duas partes com diferentes pesos, que, a rigor, poderiam ser dois ensaios distintos. Decidi, porém,
...
\section*{\scalebox{.8}{NEOLIBERALISMO E A EDUCAÇÃO~SENTIMENTAL}}
...
\section*{\scalebox{.8}{PEQUENA TEORIA VISUAL DO MEDO}}
...
\noindent{}Rivera Garza aborda mais este caso de
...
sobre como conseguiram \linebreak 
...
\noindent{}convencer seus próprios garçons e taxistas que
...
\chapter*{A incerteza\vspace{-.15cm}\break política em 2018\vspace{-.15cm}\break {\slsc{Uma coleção de}}\vspace{-.15cm}\break {\slsc{sonhos e pesadelos}}\footnote{Texto originalmente publicado no {\slsc{Nexo Jornal}} em 10/11/2018, em parceria com o psicanalista William Zeytounlian. O ensaio trata de sonhos e pesadelos de algumas pessoas durante o pleito eleitoral de 2018, que elegeu Bolsonaro como Presidente da República.}}
...
\section*{\scalebox{.8}{Cena 1. BOLSONARO E OS 30 MIL MORTOS}}
...
\section*{\scalebox{.8}{Cena 2. “CARTA BRANCA” PARA MATAR}}
...
\section*{\scalebox{.8}{Cena 3. AS MASSAS E O MITO}}
...
\section*{\scalebox{.8}{POLÍTICA E PARANOIA}}
...
\section*{\scalebox{.8}{HIGIENIZAÇÃO SOCIAL}}
...
\section*{\scalebox{.8}{A FICÇÃO DO CONTROLE TOTAL}}
...
\section*{\scalebox{.8}{NOTA GERAL SOBRE O IMAGINÁRIO}\break \scalebox{.8}{DA CATÁSTROFE}}
...
\section*{\scalebox{.8}{Cena 4. PRONUNCIAMENTO}\break \scalebox{.8}{OFICIAL DE JAIR BOLSONARO SOBRE}\break \scalebox{.8}{CORONAVÍRUS EM REDE NACIONAL}}
...
\section*{\scalebox{.8}{CONFISCAR O TEMPO, SEQUESTRAR OS CORPOS}}
...
\chapter*{Apêndice\vspace{-.15cm}\break {\slsc{Xamanismo}}\vspace{-.15cm}\break {\slsc{na esplanada}}}

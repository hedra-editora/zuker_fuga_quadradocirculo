...
\caption{\footnotesize{\Formular{\emph{Building Cuts}, de Gordon Matta Clark}}}
\end{figure}
...
obra,\footnote{\scalebox{.8}{FOUCAULT}, Michel. {\slsc{O nascimento da biopolítica}}.}
...
que emerge entre o final do século \versal{XIX} e começo do século \versal{XX} na
...
mundo industrial com os ``selvagens'' do mundo colonial.\footnote{\scalebox{.8}{MBEMBE},
...
concentração de poder estatal, com a ascensão do patriarcalismo e o %a ascensão do patriarcalismo faz parte da concentração estatal ou é um dos termos que ela correlaciona? repensar lugar da vírgula
...
com variadas teias de dependência entre espécies?\footnote{\scalebox{.8}{TSING},
  Anna. ``Margens indomáveis: cogumelos como espécies companheiras''. {\slsc{\scalebox{.8}{ILHA}}}, v.~17, n.~1, p.~177-201, jan./jul. 2015, p.~184.} %O que é a repetição do número de pagina?
\end{quote}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Anwar Congo encena como realizava o assassinato de chineses, durante o golpe militar indonésio. Frame do filme o \emph{Ato de Matar} (2012)}}}
\end{figure}
...
O desafio é olhar para a violência do século \versal{XX}, o século mais sangrento
...
%\caption{\footnotesize{\Formular{Frame de \emph{O Ato de Matar} (2012)}}}
%\end{figure}
...
\versal{XXI}. A proposta era explorar as contradições de tais processos, e entrar
...
seus principais atributos''.\footnote{\scalebox{.8}{MBEMBE}, Achille.
  {\slsc{Necropolítica}}. Espanha: Editorial Melusina, 2011, p.~19-20.}
...
coisas ouvidas.\footnote{\scalebox{.8}{GÊNOVA} apud \scalebox{.8}{BAXANDALL}, Michael. {\slsc{O olhar renascente: pintura e experiência social na Itália da Renascença}}. Rio de Janeiro: Editora Paz e Terra, 1991.} %página?
\end{quote}
...
estudos de Carlo Ginzburg sobre Piero della Francesca.\footnote{\scalebox{.8}{GINZBURG},
  Carlo. {\slsc{Investigando Piero: o Batismo, o ciclo de Arezzo,
    a Flagelação de Ulbino}}. São Paulo: Cosac \& Naify, 2010.} Tento
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{A decapitação de São João Batista, de Giovanni Caravaggio}}}
\end{figure}
...
feudal e ao rei, se constrói a partir do comerciante urbano''.\footnote{\scalebox{.8}{WARBURG}, Aby. {\slsc{Essais florentins}}. Paris: Klincksieck, 2003, p.~117 (trad. nossa).}
...
o passado''.\footnote{\scalebox{.8}{MICHAUD}, Philippe"-Alain. {\slsc{Aby
  Warburg et l'image en mouvement}}. Paris: Éditions Macula, 2012 (trad. nossa).} %pagina??
...
Em seu ensaio acerca dos significados do terror na Colômbia,\footnote{\scalebox{.8}{URIBE
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{Massacre do Carandiru}}}
\end{figure}
...
flinching.\footnote{\scalebox{.8}{SONTAG}, Susan. {\slsc{Regarding the pain of others}}. New York: Picador, 2003, p.~41.}
\end{quote}
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{\emph{Frame} de \emph{Nostalgia de la Luz}, filme de Patricio Guzman}}}
\end{figure}
...
plano econômico em que é reivindicada: ``de fato, acredito que deve se %reivindicada concorda com o que aqui?	
...
\centering
 \includegraphics[width=85mm]{./imgs/im1.jpg}
\caption{\footnotesize{\Formular{A Incredulidade de São Tomás, de Giovanni Caravaggio}}}
\end{figure}
...
resguarda aos Achuar e demais povos indígenas no mundo: ``tsodos nós
...
De tão absurda como imagem que chega a parecer inimaginável, a ideia de
...
recentes, estão os projetos de construção de usinas hidrelétricas na
...
documentário \emph{Belo Monte: After the Flood}, do cineasta canadense Todd
...
perseguições, o que dá uma ideia do clima no país), é originária de
...
extravagant new economies of profit"-as well as loss''. %tem esse hífen mesmo?
Uma perspectiva
...
O capitalismo extrativista resguarda à Amazônia o lugar clássico ocupado
...
como afirmou Eduardo Viveiros de Castro na aula pública que proferiu em uma
...
Pouco esperançoso com relação ao futuro que aguardava os indígenas sul"-americanos, distinguiu o conceito de etnocídio daquele de genocídio: o
...
separa aquele que escreve das pessoas que compõem o mundo descrito.
...
As dificuldades dos julgamentos eram evidentes para Walsh. Pesadas todas as
...
narração. Em meio às torpes causadas por acontecimentos demasiado
...
acontecido sob os governos do \versal{PT}, ainda deixava a desejar; a polícia
...
então fazíamos parte. Nos bares, que mais bem eram botecos, a sensação %que mais bem eram botecos
...
Kapuscinski faz um mergulho no dia a dia e na vida iranianos para
...
cumprimentar e saudar, com longas conversas sobre familiares; traços que
...
A análise da ditadura de Uganda, um governo que funciona com base no
...
e, finalmente, marechal"-de"-campo vitalício. Pendurava cada vez mais %marechal assim mesmo em c.b.?
...
Alberto para cobrir a situação de cheias em Anamã, que duram cerca de
...
que índios são vagabundos e têm muita terra, entre outras falas
...
\versal{PSDB} e \versal{PMDB}) se mostraram imiscuídos à corrupção. Ou mais, que a
corrupção é o óleo que permite à engrenagem política funcionar, e que
...
Dilma Rousseff do poder, que em ciência política recebe o nome de golpe %manter essa repetição degolpe branco?
...
``O que os mexicanos do início desse século temos sido obrigados a ver %nós mexicanos?
...
Essas histórias pessoais lhes servem de mote para essa reflexão %lhe, certo?
...
A obra também adentra a situação dos feminicídios e as violências
...
contrária aos apartamentos impostos pelas formas de violência. Frente à
...
isso ficou claro. Mas mais do que contra o \versal{PT}, era um voto contra um
...
Lembro de uma entrevista que Dilma Rousseff deu a um meio de comunicação
...
de algumas pessoas que estivessem decididas a votar em um candidato tão
truculento.
...
indígenas e \versal{LGBTQI}s demandando espaço, o que implica o questionamento de
...
Os governos autoritários, sejam eles capitalistas ou comunistas, usam de
...
Em meio a minha afobação, indo e vindo frente ao Congresso, buscando,
